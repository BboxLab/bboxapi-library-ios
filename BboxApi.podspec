#
#  Be sure to run `pod spec lint BboxApi.podspec.podspec' to ensure this is a
...
s.author             = "Bouygues Telecom | BboxLab"
# Or just: s.author    = ""
# s.authors            = { "" => "salmiaiman@gmail.com" }
